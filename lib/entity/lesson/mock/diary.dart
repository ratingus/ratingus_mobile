...
getCurrentDayDiary(DateTime day) {
  ...
  return DayLessonDetail(
    dateTime: dayLesson.dateTime,
    studies: dayLesson.studies
...
getCurrentWeekDiary(DateTime date) {
  ...
  return <DayLesson>[
    DayLesson(dateTime: weekStart, studies: [
      Lesson(
        timetableNumber: 1,
        studyId: 1,
    ...
    DayLesson(dateTime: weekStart.add(const Duration(days: 1)), studies: [
      Lesson(
        timetableNumber: 1,
        studyId: 1,
        subject: "Русский язык",
    ...
    DayLesson(dateTime: weekStart.add(const Duration(days: 2)), studies: [
      Lesson(
        timetableNumber: 1,
        studyId: 1,
        subject: "Русский язык",
    ...
    DayLesson(dateTime: weekStart.add(const Duration(days: 3)), studies: [
      Lesson(
        timetableNumber: 1,
        studyId: 1,
        subject: "Русский язык",
    ...
    DayLesson(dateTime: weekStart.add(const Duration(days: 4)), studies: [
      Lesson(
        timetableNumber: 1,
        studyId: 1,
        subject: "Русский язык",
    ...
    DayLesson(dateTime: weekStart.add(const Duration(days: 5)), studies: [
      Lesson(
        timetableNumber: 1,
        studyId: 1,
        subject: "Русский язык",
